...
class Stock extends FormzInput<int, StockError> {
  ...
  String? get errorMessage {
    ...
    if (displayError == StockError.value) return 'Debe ser igual o mayor a 0';
    if (displayError == StockError.format) return 'El formato es inválido';
    return null;
  }
  ...
  StockError? validator(int value) {
    if (value.toString().isEmpty || value.toString().isEmpty)
